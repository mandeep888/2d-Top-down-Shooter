...
public class EnemyMovement : MonoBehaviour
{
    ...
    // {
    //     _targetDirection = new Vector2(-_targetDirection , _targetDirection.y);
    // }
    ...
    // {
    //     _targetDirection = new Vector2(_targetDirection.x, -_targetDirection );
    // }
    // }
    ...
    private void HandleEnemyOffScreen()
    {
        ...
        if ((screenPosition.y < _screenBorder && _targetDirection.y < 0) || (screenPosition.y > _camera.pixelHeight - _screenBorder && _targetDirection.y > 0))
        {
            _targetDirection.y = -_targetDirection.y;
        }
    }
